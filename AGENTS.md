...
Preserve proposal, authorization, execution, verification, and durable write-back as distinct stages. Provider actual state is external; the repository's non-secret state projection is the durable handoff record, and chat memory is not authoritative.
